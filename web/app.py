...
POSTGRES_URL = get_database_url() #postgres://postgres:{password}@{hostname}:5432/postgres
setup_database(POSTGRES_URL) #pass in postgres://postgres:{password}@{hostname}:5432/postgres
